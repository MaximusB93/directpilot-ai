...
def _report(
    ...
    *,
    ...
    return DirectReadCapability(
        ...
        required_fields=fields, incompatible_fields=incompatible_fields,
        default_limit=min(200, limit), maximum_limit=limit,
...
YANDEX_DIRECT_READ_CAPABILITIES: dict[str, DirectReadCapability] = {
    ...
    "keyword_performance": _report("keyword_performance", "Эффективность ключевых фраз", "CRITERIA_PERFORMANCE_REPORT", ("CampaignId", "CampaignName", "AdGroupId", "AdGroupName", "CriterionId", "Criterion", "CriterionType") + PERFORMANCE_FIELDS, families=SEARCH_FAMILIES, subtypes=SEARCH_SUBTYPES, incompatible_fields=(("CriterionId", "CriteriaId"), ("Criterion", "Criteria"), ("CriterionType", "CriteriaType"))),
    "criteria_performance": _report("criteria_performance", "Эффективность критериев", "CRITERIA_PERFORMANCE_REPORT", ("CampaignId", "CampaignName", "AdGroupId", "AdGroupName", "CriterionId", "Criterion", "CriterionType") + PERFORMANCE_FIELDS, incompatible_fields=(("CriterionId", "CriteriaId"), ("Criterion", "Criteria"), ("CriterionType", "CriteriaType"))),
    "search_queries": _report("search_queries", "Поисковые запросы", "SEARCH_QUERY_PERFORMANCE_REPORT", ("CampaignId", "CampaignName", "AdGroupId", "AdGroupName", "Query") + PERFORMANCE_FIELDS, families=SEARCH_FAMILIES, subtypes=SEARCH_SUBTYPES, cost="high", limit=1500),
    ...
    "ad_creative_metadata": _service("ad_creative_metadata", "Метаданные объявлений", "ads", _AD_FIELDS, ("type", "status", "state"), extra_params=(("TextAdFieldNames", _TEXT_AD_FIELDS),)),
...
for _item in (
    ...
    _unavailable("creatives", "Креативы", "direct_creatives_adapter"),
