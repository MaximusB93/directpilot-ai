...
const checks = [
  ...
  ['frontend architecture docs', frontendArchitecture.includes('Controller layer') && frontendArchitecture.includes('AI controller state/context helpers wired') && frontendArchitecture.includes('Move AI async flows')],
  ...
  ['main ai chat store delegation', js.includes('aiStore.addAiChatMessage(currentAiChatState()') && js.includes('aiChatRequestPayload(text)')],
