...
const checks = [
  ...
  ['dashboard renderer adapter', dashboardPage.includes('renderDashboardPage') && dashboardPage.includes('legacyRenderDashboard') && dashboardPage.includes('adapter-ready')],
