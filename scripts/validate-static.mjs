...
const checks = [
  ...
  ['app page router', appPageRouter.includes('resolveAppPage') && appPageRouter.includes('getPageRenderer') && appPageRouter.includes('resolvePageRenderer')],
  ...
  ['pages registry', pagesRegistry.includes('APP_PAGES') && pagesRegistry.includes('PAGE_CONTRACTS') && pagesRegistry.includes('PAGE_RENDERERS') && pagesRegistry.includes('getPageRenderer')],
  ['dashboard renderer adapter', dashboardPage.includes('renderDashboardPage') && dashboardPage.includes('legacyRenderDashboard') && dashboardPage.includes('partial-builders-ready')],
  ['dashboard extracted builders', dashboardPage.includes('renderDashboardIntro') && dashboardPage.includes('renderDashboardNextStepPanel') && dashboardPage.includes('extractedBuilders')],
