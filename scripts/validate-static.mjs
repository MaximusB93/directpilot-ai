...
const checks = [
  ...
  ['integrations content composer', integrationsPage.includes('content-composer-ready') && integrationsPage.includes('renderIntegrationsIntro') && integrationsPage.includes('renderYandexConnectPanel') && integrationsPage.includes('renderClientYandexAccountPanel') && integrationsPage.includes('renderIntegrationsContent')],
  ...
  ['ai assistant content composer', aiAssistantPage.includes('content-composer-ready') && aiAssistantPage.includes('renderAiAssistantIntro') && aiAssistantPage.includes('renderAiStatusPanel') && aiAssistantPage.includes('renderAiPromptDebugPanel') && aiAssistantPage.includes('renderAiChat') && aiAssistantPage.includes('renderClientAiRecommendations') && aiAssistantPage.includes('renderAiQuickActions') && aiAssistantPage.includes('renderAiAssistantContent')],
  ...
  ['optimization content composer', optimizationPage.includes('content-composer-ready') && optimizationPage.includes('renderOptimizationIntro') && optimizationPage.includes('renderOptimizationPlanPanel') && optimizationPage.includes('renderOptimizationActionsPanel') && optimizationPage.includes('renderOptimizationContent')],
